...
int main(int argc, char **argv)
{
    ...
    // building main.cpp
    if (nob_needs_rebuild1(BUILD_DIR"main"EXT, "src/main.cpp")) {
        #ifdef _WIN32
        // do nothing for now
        #else
    ...
    //building server
    if (nob_needs_rebuild1(BUILD_DIR"server"EXT, "server/main.cpp")) {
        #ifdef _WIN32
    ...
    //building client
    if (nob_needs_rebuild1(BUILD_DIR"client"EXT, "client/main.cpp")) {
        #ifdef _WIN32
