...
BEGIN {
    ...
    require '/Users/ameya/Programming/p2p-file-transfer/thirdparty/openssl-4.0.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/ameya/Programming/p2p-file-transfer/thirdparty/openssl-4.0.1/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/Users/ameya/Programming/p2p-file-transfer/thirdparty/openssl-4.0.1/test/default-and-jitter.cnf';
    shift;
